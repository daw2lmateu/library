    ...
    if(isset($_GET['id'])){ 
      ...
      { ?>
        <section class="container green-text">
            <h4 class="center">Modificar Reserva Electronica</h4>
            <form class="white" action="index.php" method="POST">
                ...
                <br><br><br>
                <div class="center">
                    <input type="submit" name="content" value="Actualiza Reserva Ebook" class="btn brand z-depth-0">
                </div>
            </form>
        </section>
        <?php
        ...
        <section class="container green-text">
            ...
            <form class="white" action="index.php" method="GET">
                ...
                <div class="center">
                            <input type="submit" name="content" value="Editar Reserva Ebook" class="btn brand z-depth-0">
                </div>
        <?php
    }
?>
